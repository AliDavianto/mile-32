...
<body>
    ...
    <div class="image-container">
        ...
        <div class="text-container">
            <h4 class="payment-success">PEMBAYARAN BERHASIL</h4>
            {{-- <p class="total-price">Total Harga: Rp 00.00</p> --}}
            <p class="order-status">Pesanan anda sedang di proses</p>
            <p class="enjoy-message">“Selamat Menikmati hidangan yang akan disajikan”</p>

            <!-- Teks Back To Home -->
            <a href="/menu" class="back-to-home">Back To Home</a>
